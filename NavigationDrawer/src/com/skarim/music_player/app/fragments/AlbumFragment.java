...
import com.skarim.music_player.app.activities.AlbumSongsActivity;
import com.skarim.music_player.app.activities.PlayerActivity;
import com.skarim.music_player.app.activities.R;
import com.skarim.music_player.app.adapters.AlbumAdapter;
import com.skarim.music_player.app.asynchronoustask.AlbumLoader;
...
public class AlbumFragment extends Fragment implements
		LoaderManager.LoaderCallbacks<ArrayList<Album>>, OnClickListener,
		OnItemClickListener {
	...
	private void updatePlayButton() {
		if (PlayerActivity.mediaPlayer != null
			...
			String songName = CurrentPlayingSongs.getSongsList()
					.get(CommonConstraints.CURRENT_CURSOR_POSITION)
					.getSongName();
			String artistName = CurrentPlayingSongs.getSongsList()
					.get(CommonConstraints.CURRENT_CURSOR_POSITION)
					.getArtistName();
	...
	@Override
	public void onLoadFinished(Loader<ArrayList<Album>> arg0,
			ArrayList<Album> arg1) {
		albumList = arg1;
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			long arg3) {
		Intent player = new Intent(getActivity(), AlbumSongsActivity.class);
		player.putExtra("ALBUM_NAME", albumList.get(position).getAlbumName());
		// setUI();
