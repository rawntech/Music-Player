	...
	public static ArrayList<Album> getAllAlbums(Context context) {
		...
		if(cursor!=null && cursor.moveToFirst()) {
            do {
                ...
                final int numberOfSongs=cursor.getInt(4);
             ...
             // Create a new album
                ...
                final Album album = new Album(albumName, artistName, cover, coverPath,numberOfSongs);
                albumList.add(album);
	...
	public static ArrayList<Album> getAlbumsForArtist(Context context, String artistname) {
		...
		if(cursor!=null && cursor.moveToFirst()) {
            do {
                ...
                // Get artist name
                final String artistName = cursor.getString(2);
                final int numberOfSongs=cursor.getInt(3);
		...
		ArrayList<Song> artistSongList = new ArrayList<Song>();
	      ...
	      if(cursor!=null && cursor.moveToFirst()) {
            do {
                ...
                String coverpath=cursor.getString(6);
                
                // Create a new album
                final Song song = new Song(songname, artistname, albumname, duration,path,coverpath);
